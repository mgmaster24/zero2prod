...
impl EmailClient {
    pub fn new(base_url: String, sender: UserEmail, auth_token: SecretString) -> Self {
        let base_url = Url::parse(&base_url).expect("base_url should be a well formed URL string.");
        Self {
    ...
    pub async fn send_email(
        ...
        let url = self
            .base_url
            .join("/email")
            .expect("Failed to join base_url with /email");
